...
DEPRECATED_OPERATION(MozorientationDeprecated)
DEPRECATED_OPERATION(MozorientationchangeDeprecated)
DEPRECATED_OPERATION(MozlockorientationDeprecated)
DEPRECATED_OPERATION(MozunlockorientationDeprecated)

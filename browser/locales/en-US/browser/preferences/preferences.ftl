...
settings-pane-labs-title = Lykon
settings-category-labs =
    .tooltiptext = Lykon
pane-experimental-description4 = Give our experimental features a try! They’re in development and evolving, which could impact how Lykon works. We only receive data about your use of these features if you have <a data-l10n-name="data-collection">technical and interaction data</a> turned on.

pane-experimental-reset =
  .label = Restore Defaults
  .accesskey = R

help-button-label = Lykon Support
...
feature-enable-requires-restart = Lykon must restart to enable this feature.
feature-disable-requires-restart = Lykon must restart to disable this feature.
should-restart-title = Restart Lykon
should-restart-ok = Restart Lykon now
...
extension-controlling-proxy-config = <img data-l10n-name ="icon"/> <strong>{ $name }</strong> controls how Lykon connects to the internet.
...
search-results-help-link = Need help? Visit <a data-l10n-name="url">Lykon Support</a>
...
always-check-default =
    .label = Always check if Lykon is your default browser
    .accesskey = y

is-default-browser =
    .message = Lykon is currently your default browser

is-not-default-browser =
    .message = Lykon is not your default browser
...
windows-launch-on-login =
    .label = Open Lykon automatically when your computer starts up
    .accesskey = O
...
warn-on-open-many-tabs =
    .label = Warn you when opening multiple tabs might slow down Lykon
    .accesskey = d
...
preferences-web-appearance-choice-auto2 =
  .label = Automatic
  .title = Automatically change website backgrounds and content based on your system settings and Lykon theme.
...
preferences-web-appearance-link =
    .label = Manage Lykon themes in Extensions & Themes
...
choose-browser-language-description = Choose the languages used to display menus, messages, and notifications from Lykon.
manage-browser-languages-button =
  .label = Set Alternatives…
  .accesskey = l
confirm-browser-language-change-description = Restart Lykon to apply these changes
...
applications-description = Choose how Lykon handles the files you download from the web or the applications you use while browsing.
...
applications-handle-new-file-types-description = What should Lykon do with other files?
...
update-application-title = Lykon Updates

update-application-description = Keep Lykon up to date for the best performance, stability, and security.

# Variables:
# $version (string) - Lykon version
...
update-application-allow-description = Allow Lykon to
...
update-application-background-enabled =
    .label = When Lykon is not running
    .accesskey = W

update-application-warning-cross-user-setting = This setting will apply to all Windows accounts and Lykon profiles using this installation of Lykon.
...
update-setting-write-failure-message2 =
    Lykon encountered an error and didn’t save this change. Note that changing this update setting requires permission to write to the file below. You or a system administrator may be able resolve the error by granting the Users group full control to this file.

    Could not write to file: { $path }

update-in-progress-title = Update In Progress

update-in-progress-message = Do you want Lykon to continue with this update?
...
performance-limit-content-process-blocked-desc = Modifying the number of content processes is only possible with multiprocess Lykon. <a data-l10n-name="learn-more">Learn how to check if multiprocess is enabled</a>
...
network-proxy-connection-description = Configure how Lykon connects to the internet.
...
home-prefs-content-header =
    .label =  Lykon 
home-prefs-content-header2 =  Lykon Content
home-prefs-content-description2 = Choose what content you want on your Lykon screen.
...
search-suggestions-cant-show-2 =
    .message = Search suggestions will not be shown in location bar results because you have configured Lykon to never remember history.
...
addressbar-header-firefox-suggest-2 =
    .label = Lykon
    .description = Suggestions from Lykon and our partners in your address bar.
...
addressbar-dismissed-suggestions-label-2 =
    ...
    .description = Restore dismissed suggestions from sponsors and Lykon.
...
autofill-creditcard-os-dialog-message = { PLATFORM () ->
    ...
    *[other] Lykon is trying to change the settings for payment methods. Use your device sign in to allow this.
}
...
history-remember-label2 = Lykon will
...
history-remember-description3 =
    ...
    .description = Lykon will remember your browsing, download, form, and search history.

history-dontremember-description3 =
    .aria-label = { history-remember-label2 }
    .description = Lykon will use the same settings as private browsing, and will not remember any history as you browse the Web.

history-custom-description3 =
    .aria-label = { history-remember-label2 }
    .description = Lykon will use custom settings for your browsing, download, form and search history.
...
history-clear-on-close-option =
    .label = Clear history when Lykon closes
    .accesskey = r
...
sitedata-delete-on-close =
    .label = Delete cookies and site data when Lykon is closed
    .accesskey = c

sitedata-delete-on-close-private-browsing3 =
    .message = Based on your history settings, Lykon deletes cookies and site data from your session when you close the browser.
...
cookie-banner-blocker-description = When a site asks if they can use cookies in private browsing mode, Lykon automatically refuses for you. Only on supported sites.
...
content-blocking-section-top-level-description = Trackers follow you around online to collect information about your browsing habits and interests. Lykon blocks many of these trackers and other malicious scripts.

content-blocking-learn-more = Learn more

content-blocking-fpi-incompatibility-warning = You are using First Party Isolation (FPI), which overrides some of Lykon’s cookie settings.

# There is no need to translate "Resist Fingerprinting (RFP)". This is a
# feature that can only be enabled via about:config, and it's not exposed to
# standard users (e.g. via Settings).
content-blocking-rfp-incompatibility-warning = You’re using Resist Fingerprinting (RFP), which replaces some of Lykon’s fingerprinting protection settings. This might cause some sites to break.
...
content-blocking-etp-blocking-desc = Lykon blocks the following:
...
content-blocking-and-isolating-etp-warning-description-4 = Lykon recommends using the “Fix site issues” settings to reduce broken site features and content. If a site seems broken, try turning off tracking protection for that site to load all content.
...
content-blocking-baseline-uncheck-warning-dialog-body = This setting helps fix the most common site problems. If you turn it off, some sites may not work, and Lykon won’t be able to help troubleshoot those issues.
...
permissions-notification-pause =
    .label = Pause notifications until Lykon restarts
    .accesskey = n
...
collection-header2 = Lykon Data Collection and Use
...
collection-studies-link = View Lykon studies
...
certs-description2 =
    .label = Certificates
    .description = Configure the certificates that Lykon uses for authentication.
...
certs-thirdparty-toggle =
    .label = Allow Lykon to automatically trust third-party root certificates you install
    .accesskey = t
...
space-alert-over-5gb-message2 = <strong>Lykon is running out of disk space.</strong> Website contents may not display properly. You can clear stored data in Settings > Privacy & Security > Cookies and Site Data.

space-alert-under-5gb-message2 = <strong>Lykon is running out of disk space.</strong> Website contents may not display properly. Visit “Learn more” to optimize your disk usage for better browsing experience.
...
httpsonly-label =
    ...
    .description = Only allows secure connections to websites. Lykon will ask before connecting insecurely.
...
httpsonly-radio-disabled3 =
    ...
    .description = Lykon may still upgrade some connections
...
preferences-doh-setting-default =
  ...
  .accesskey = D
preferences-doh-default-desc = Lykon decides when to use secure DNS to protect your privacy.
...
preferences-doh-default-detailed-desc-5 = Turn off when a network tells Lykon it shouldn’t use secure DNS
...
preferences-doh-setting-strict =
  ...
  .accesskey = M
preferences-doh-strict-desc = Lykon will always use secure DNS. You’ll see a security risk warning before we use your system DNS.

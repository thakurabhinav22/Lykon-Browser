...
function openLykonShieldPreferences() {
  openPreferences("lykonShield");
}

window.addEventListener("load", () => {
  const btn = document.getElementById("lykon-shield-button");
  if (btn) {
    btn.addEventListener("command", openLykonShieldPreferences);
  }
});
function openLykonBugReport() {
  // Open GitHub "New Issue" page
  openTrustedLinkIn(
    "https://github.com/thakurabhinav22/Lykon-Browser/issues/new",
    "tab"
  );
}

...
// Custom LyKon startup and new tab behavior

// 0 = blank, 1 = homepage, 2 = last page, 3 = restore session
pref("browser.startup.page", 1); 
// Open homepage on startup

// DO NOT set browser.startup.homepage manually — the * override in jar.mn already handles new tabs
// Setting it causes the double-path "browser/content/browser/" bug
pref("browser.startup.homepage", "chrome://browser/content/CustomUI/newtab.html"); 

// Completely disable Activity Stream (Firefox Home) — critical for custom new tab
pref("browser.newtabpage.activity-stream.enabled", false);

// Extra safety to prevent any fallback to default new tab
pref("browser.newtabpage.enabled", false);

// Disable about:home caching (not needed)
pref("browser.startup.homepage.abouthome_cache.enabled", true);

// Skip homepage on first run
pref("browser.startup.firstrunSkipsHomepage", true);

// Prevent session restore infobar
pref("browser.startup.couldRestoreSession.count", 0);
// Prevents session restore infobar from showing
...
//Add blocking 
// Force strict blocking
pref("browser.contentblocking.category", "strict");

// Disable user override
pref("browser.contentblocking.features.strict", true);
...
// Enable ETP everywhere
pref("privacy.partition.network_state", true);


// Enable URL classifier blocking
pref("browser.safebrowsing.malware.enabled", true);
pref("browser.safebrowsing.phishing.enabled", true);

// Enable additional blocklists
pref("urlclassifier.trackingTable", "tracking-protection-fingerprinting,tracking-protection-cryptomining,tracking-protection-social,tracking-protection");
pref("urlclassifier.features.socialtracking.annotate.enabled", true);

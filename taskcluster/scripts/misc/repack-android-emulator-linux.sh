...
# Bug 2007619: override platform-tools to a known working version
curl --fail -L https://dl.google.com/android/repository/platform-tools_r36.0.0-linux.zip > /tmp/platform-tools.zip
